      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-10">
          ...
          <div className="flex flex-col items-start">
            <a href="/" className="mb-3 inline-block" aria-label="AVBT Technologies Home">
              <div className="h-12 w-auto max-w-[220px] flex items-center justify-start">
                <img src="/logo.png" alt="AVBT Technologies" width="180" height="48" loading="lazy" decoding="async" className="h-full w-auto object-contain drop-shadow-[0_2px_10px_rgba(59,130,246,0.3)]" />
              </div>
            </a>
            <p className="text-xs text-neutral-400 mb-2 font-sans leading-relaxed">
              AVBT Technologies — Digital design, development, creative production and AI automation for businesses building what comes next.
            </p>
            <p className="text-[11px] text-neutral-500 mb-4 font-sans leading-relaxed">
              Based in Solan, Himachal Pradesh, India. Working with clients in India and internationally where remote delivery is suitable.
            </p>
            <div className="flex items-center gap-2.5">
              <a
                ...
                aria-label="AVBT Technologies on LinkedIn"
                title="AVBT Technologies on LinkedIn"
              >
              ...
              <a
                ...
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-full border border-white/10 flex items-center justify-center text-neutral-400 hover:text-white hover:border-white/30 hover:bg-white/5 transition-all duration-300"
                aria-label="AVBT Technologies on GitHub"
                title="AVBT Technologies on GitHub"
              >
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/portfolio" className="hover:text-white transition-colors text-sm">Work</a></li>
              ...
              <li><a href="/#contact-form" className="hover:text-white transition-colors text-sm">Contact</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="/terms-conditions" className="hover:text-white transition-colors text-sm">Terms &amp; Conditions</a></li>
        ...
        <div className="pt-6 border-t border-white/5 flex items-center justify-center text-center text-xs text-neutral-500">
          <p>© 2026 AVBT Technologies. All Rights Reserved. | Solan, Himachal Pradesh, India.</p>
        </div>
      </div>
    </footer>
  );
