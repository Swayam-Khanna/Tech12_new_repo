...
To exercise any of these rights, please contact us at contact@avbt.in.`,
  },
  {
...
export default function PrivacyPolicy() {
  ...
  return (
    <main className="min-h-screen bg-background">
      <SEO 
        title="Privacy Policy — AVBT Technologies | How We Protect Your Data"
        description="Learn how AVBT Technologies collects, uses, and protects your personal information. We respect your privacy and never sell your data."
        keywords="privacy policy AVBT technologies, data protection, digital agency Solan"
      />
      <Navbar />
